...
Write-Host "1. If admin login failed, run the admin reset script:" -ForegroundColor Magenta
Write-Host "   - On local environment: .\reset-admin-password.bat" -ForegroundColor Magenta
Write-Host "   - On Render: Use the reset-admin.sh script" -ForegroundColor Magenta
